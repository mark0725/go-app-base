...
func init() {
	g_DBHelpers["mysql"] = &MysqlHelper{}
}

func (helper *MysqlHelper) InsertSqlBuilder(table string, params map[string]any, rawParams []string, options map[string]any) SqlBuildResult {
	defaultDate := true
	if options != nil {
...
func (helper *MysqlHelper) UpdateSQLBuilder(table string, params, filters map[string]any, wheres string) SqlBuildResult {
	var values string
...
func (helper *MysqlHelper) QueryBaseSqlBuilder(sql string, params map[string]any) error {
	return nil

}

// QueryNamedParamsBuilder function
func (helper *MysqlHelper) QueryNamedParamsBuilder(sqlOld string, params map[string]any) SqlBuildResult {
	var sqlParams []any
	sql := sqlOld
